...
- **Speed**: Performance varies with image size and object count; see the [v0.2.0 performance report](benchmarks/releases/v0.2.0.md) for release-wide and incremental CI benchmarks. Granularity remains one of the more expensive measurements and can be skipped when throughput is critical.
